...
def main(zoom):
    ...
    if(zoom == 14):
        """
        page.goto('https://whoer.net', timeout=60000)
    ...
    # find sponsored
    sponsoredListings = page.locator('//a[contains(@href, "https://www.google.com/maps/place")]').locator('..').locator('h1').locator('..').locator('..').locator('..').locator('..').all()
    
    for sponsoredListing in sponsoredListings:
        print(f"sponsor: {sponsoredListing.locator('h1').inner_text()}")
    ...
    while True:
        ...
        page.wait_for_timeout(1000)
        sponsor_count = page.locator('//a[contains(@href, "https://www.google.com/maps/place")]').locator('..').locator('h1').locator('..').locator('..').locator('..').locator('..').count()
        total_all = total + sponsor_count
        ...
        if (
            ...
            listings_filtered = [listing.locator('..').filter(has_not=listing.locator('h1')) for listing in listings]
            print(f"Total Scraped: {len(listings)}")
            print(f"Total Filtered: {len(listings_filtered)}")
